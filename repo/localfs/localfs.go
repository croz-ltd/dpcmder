...
func (r LocalRepo) GetFileTypeFromPath(m *model.Model, filePath string) model.ItemType {
...
func (r LocalRepo) GetFileType(m *model.Model, parentPath, fileName string) model.ItemType {
